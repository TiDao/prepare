...
func TestNodeCreate(t *testing.T){
	chain1,_ := NewChainMakerType("/home/magatron/.kube/config","wx-org1-chainmaker-org","test","10","../output/chainmaker/ca","../output/chainmaker/wx-org1-chainmaker-org/config","../output/chainmaker/wx-org1-chainmaker-org/node","../output/chainmaker/wx-org1-chainmaker-org/user")
