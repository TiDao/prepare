...
import (
	"chainmaker.org/chainmaker-go/common/httputils"
...
func (client AlertClient) SendUserAlertSync() error {
	...
	resp, err := httputils.POST(client.alarmCenterUrl+USER_ALERT_URI, client.alertInfo)
	if err != nil {
		return err
	}
...
func (client AlertClient) SendUserAlert() error {
	...
	go httputils.POST(client.alarmCenterUrl+USER_ALERT_URI, client.alertInfo)
